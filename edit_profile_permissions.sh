...
sed -i '/file_permissions/a ["/root/lib/"]="1000:1000:770"' build/releng/profiledef.sh
sed -i '/file_permissions/a ["/root/post-install/"]="1000:1000:770"' build/releng/profiledef.sh
sed -i '/file_permissions/a ["/root/profiles/"]="1000:1000:770"' build/releng/profiledef.sh
